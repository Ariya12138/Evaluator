...
from .constants import OPENAI_MODEL_DICT
import sys
...
class BLEU(BaseMetric):
    ...
    def calculate_bleu_metric(self, data):
...
class BLEU_1(BLEU):
    ...
    def calculate_metric(self, data):
        ...
        total_bleu, score_list = self.calculate_bleu_metric(data)
        return {"bleu-1": total_bleu}, score_list
...
class BLEU_2(BLEU):
    ...
    def calculate_metric(self, data):
        ...
        total_bleu, score_list = self.calculate_bleu_metric(data)
        return {"bleu-2": total_bleu}, score_list
...
class BLEU_3(BLEU):
    ...
    def calculate_metric(self, data):
        ...
        total_bleu, score_list = self.calculate_bleu_metric(data)
        return {"bleu-3": total_bleu}, score_list
...
class BLEU_4(BLEU):
    ...
    def calculate_metric(self, data):
        ...
        total_bleu, score_list = self.calculate_bleu_metric(data)
        return {"bleu-4": total_bleu}, score_list
